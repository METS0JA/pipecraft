  ...
  state: {
    ...
    Metaworks_workflow: [
        ...
        Inputs: [
          {
            ...
            value: 1,
            disabled: "never",
            tooltip: "Phred score quality cutoff (default 13)",
            type: "numeric",
            rules: [(v) => v >= 0 || "ERROR: specify values >= 0"],
          },
          {
      ...
      },
      {
        ...
        Inputs: [
          ...
          {
            name: "cutoff_quality_3’",
            value: 20,
            disabled: "never",
            tooltip: "Phred quality score cutoffs at the ends",
            type: "numeric",
            rules: [(v) => v >= 1 || "ERROR: specify values >= 1"],
          },
          {
            name: "cutoff_quality_5’",
            value: 20,
            disabled: "never",
            tooltip: "Phred quality score cutoffs at the ends",
            type: "numeric",
          ...
          },
          {
            ...
            value: 0.1,
            disabled: "never",
            tooltip: "Error rate (default 0.1)",
            type: "numeric",
            rules: [(v) => v >= 1 || "ERROR: specify values >= 1"],
          },
          {
            name: "adapter_overlap",
            value: 3,
            disabled: "never",
            tooltip: "Minimum adapter overlap (default 3)",
            type: "numeric",
            rules: [(v) => v >= 1 || "ERROR: specify values >= 1"],
          },
          {
      ...
      {
        tooltip:
          "ITSx extractor (tick checkbox if needed otherwise skip over this section)",
        scriptName: "",
        imageName: "pipecraft/metaworks:1.11.1",
        serviceName: "ITSx",
        disabled: "never",
      ...
      {
        tooltip:
          "Select a built in classifier or link to a custom-trained dataset",
        scriptName: "",
        imageName: "pipecraft/metaworks:1.11.1",
        serviceName: "assign taxonomy",
        disabled: "never",
    ...
    customWorkflowInfo: {
      ...
      Metaworks_workflow: {
        ...
        title: "ESVs/OTU workflow for PAIRED-END reads",
      },
    },
  },
  getters: {
